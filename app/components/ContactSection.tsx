...
export default function ContactSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // Submit logic here (API call or Server Actions)
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900">Worldwide Remote Service</h4>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-5 rounded-2xl border border-emerald-100 shadow-sm max-w-sm mx-auto lg:mx-0">
              <h4 className="text-xs font-bold text-emerald-700 text-center mb-3">
                Why Contact Us?
              </h4>
          ...
          <div className="lg:col-span-7 bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm">
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              {/* Full Name */}
              <div>
                <label htmlFor="fullName" className="block text-xs font-bold text-gray-800 mb-1">Full Name</label>
                <input 
                  id="fullName"
                  name="fullName"
                  type="text" 
              ...
              {/* WhatsApp */}
              <div>
                <label htmlFor="whatsapp" className="block text-xs font-bold text-gray-800 mb-1">WhatsApp</label>
                <input 
                  id="whatsapp"
                  name="whatsapp"
                  type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="country" className="block text-xs font-bold text-gray-800 mb-1">Country</label>
                  <select 
                    id="country"
                    name="country"
                ...
                <div>
                  <label htmlFor="buildingType" className="block text-xs font-bold text-gray-800 mb-1">Building Type</label>
                  <select 
                    id="buildingType"
                    name="buildingType"
              ...
              {/* Message */}
              <div>
                <label htmlFor="message" className="block text-xs font-bold text-gray-800 mb-1">Message</label>
                <textarea 
                  id="message"
                  name="message"
                  rows={3}
              ...
              <div>
                <label className="block text-xs font-bold text-gray-800 mb-2">Select Required Service(s)</label>
