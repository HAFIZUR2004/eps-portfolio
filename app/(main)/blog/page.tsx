...
const samplePosts: BlogPost[] = [
  ...
  {
    id: 2,
    title: "Fire Safety Plan for Commercial Buildings",
    excerpt:
      "Learn how to create a comprehensive fire safety plan for your commercial building, including evacuation routes and emergency protocols.",
    image: "https://via.placeholder.com/400x250/006A4E/FFFFFF?text=Fire+Safety+Plan",
    category: "Fire Safety Plan",
    date: "05 Aug 2026",
  },
  {
    id: 3,
    title: "Understanding Fire Zone Block Plans",
    excerpt:
      "Fire zone block plans are essential for large facilities. Learn how to create and implement effective fire zone block plans.",
    image: "https://via.placeholder.com/400x250/006A4E/FFFFFF?text=Fire+Zone+Block+Plan",
    category: "Fire Zone Block Plan",
    date: "03 Aug 2026",
  },
  {
    id: 4,
    title: "Fire Hydrant Block Plan Essentials",
    excerpt:
      "Proper fire hydrant block plans ensure quick access to water during emergencies. Learn the key components and best practices.",
    image: "https://via.placeholder.com/400x250/006A4E/FFFFFF?text=Fire+Hydrant+Block+Plan",
    category: "Fire Hydrant Block Plan",
    date: "01 Aug 2026",
  },
  {
    id: 5,
    title: "Emergency Exit Plan for Office Buildings",
    excerpt:
      "Office buildings require clear emergency exit plans. Discover how to design effective exit routes and assembly points.",
    image: "https://via.placeholder.com/400x250/006A4E/FFFFFF?text=Emergency+Exit+Plan",
    category: "Evacuation Plan",
    date: "30 Jul 2026",
  },
  {
    id: 6,
    title: "Residential Fire Safety Checklist",
    excerpt:
      "Ensure your home is protected with this comprehensive fire safety checklist covering smoke detectors, extinguishers, and escape routes.",
    image: "https://via.placeholder.com/400x250/006A4E/FFFFFF?text=Residential+Fire+Safety",
    category: "Fire Safety Plan",
    date: "28 Jul 2026",
  },
];
...
const categories: Category[] = [
  ...
  { name: "Emergency Exit Plan", count: "04" },
  { name: "Residential Safety", count: "01" },
];
...
export default function BlogPage(): JSX.Element {
  ...
  const filteredPosts: BlogPost[] = samplePosts.filter((post) =>
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-gray-800">
      ...
      {/* ================= HEADER ================= */}
      <div className="mb-10 flex items-center justify-center gap-4 pt-8">
        {/* Left Decoration */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200/80 shadow-sm">
              ...
              <ul className="space-y-3 text-xs font-medium text-gray-700">
                {categories.map((cat, idx) => (
                  <li
                    key={idx}
                    className="flex justify-between items-center hover:text-emerald-600 cursor-pointer transition-colors"
                  >
                    <span>{cat.name}</span>
          ...
          <section className="lg:col-span-8">
            ...
            <div className="mt-12 text-center">
              <button className="bg-black hover:bg-gray-800 text-white font-semibold text-sm py-3 px-8 rounded-lg shadow-md transition-all active:scale-95">
                View All Services
              </button>
            </div>
          </section>
